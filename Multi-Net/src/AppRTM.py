...
def eval():
    ...
    with tf.name_scope('input'):
        ...
        val_image_batch, val_label_batch = tfRecord.createBatch('../tfRecords/test/test.RTM.tfrecords', 404)
    ...
    logits = vgg.vgg16('inputy',x, utils.num_class, False)
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, '../model/TrainRTM/model-RTM.ckpt-2400')
